...
def inputValidator(inputType, valids): #input validation function, throws invalidInput exception if fails
    while True:
        try: 
...
class invalidInput(Exception): #defining invalid input exception to throw if input validation fails
    def __str__(self):
